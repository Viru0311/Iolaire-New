...
// Asset imports
import visionAiImg from "@/assets/vision-ai-gif.png";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden font-sans selection:bg-primary/30">
      ...
      <section ref={productsRef} className="relative w-full overflow-hidden">
        ...
        <div className="relative h-screen w-full flex items-center overflow-hidden border-b border-white/10">
          <div className="absolute inset-0 z-0">
            <img src={product1} className="w-full h-full object-cover opacity-40 scale-105" alt="Vision AI" />
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <motion.div 
              ...
              className="max-w-2xl"
            >
              <span className="text-primary font-bold tracking-widest uppercase text-sm mb-4 block">Our Products</span>
              <h2 className="text-5xl md:text-7xl font-heading font-bold mb-6 text-white">Vision AI Enforcement</h2>
              ...
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-white font-bold rounded-full h-14 px-10 text-lg">
                Explore Vision AI
              </Button>
            </motion.div>
          </div>
        ...
        <div className="relative h-screen w-full flex items-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={product2} className="w-full h-full object-cover opacity-40 scale-105" alt="Document AI" />
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 flex justify-end">
            ...
            >
              <span className="text-primary font-bold tracking-widest uppercase text-sm mb-4 block">Product Suite</span>
              <h2 className="text-5xl md:text-7xl font-heading font-bold mb-6 text-white">Intelligent Document Processing</h2>
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                Enterprise-grade OCR and NLP engine that transforms unstructured data into structured intelligence. Extract, validate, and automate document-heavy workflows with 99.9% accuracy.
              </p>
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-white font-bold rounded-full h-14 px-10 text-lg">
                Explore IDP
              </Button>
